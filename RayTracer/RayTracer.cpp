...
{
	//light
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 5.0f, 5.0f, 3.0f }, 1.0f, std::make_unique<Emissive>(color3{ 40, 40, 40 })));

	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 0, 0.50f, -1.0f }, 0.5f, std::make_unique<Lambertian>(color3{ 0, 1, 0 })));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 1.25f, 0.50f, -1.0f }, 0.5f, std::make_unique<Metal>(color3{ 1, 1, 1 }, 0.1f)));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ -1.25f, 0.50f, -1.0f }, 0.5f, std::make_unique<Dielectric>(color3{ 1, 1, 1 }, 2.0f)));
